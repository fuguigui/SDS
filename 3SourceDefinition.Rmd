...
write.csv(node_info,file="./data/Nodes/node_info.csv")
```

```{r edgelist}

edgelist<-c("Af1","Af2","Af1","As1","Af1","")
...
node_confirm<-AllCountryToNode(covid_confirm,node_geo$Node,node_info)
node_deadnum<-AllCountryToNode(covid_deadnum,node_geo$Node,node_info)
node_recover<-AllCountryToNode(covid_recover,node_geo$Node,node_info)

write(node_confirm,file="./data/Nodes/Confirm.csv")
write(node_deadnum,file="./data/Nodes/Death.csv")
write(node_recover,file="./data/Nodes/Recover.csv")
...
head(node_info)
node_info_pop<-left_join(node_info,pop_dat,by=c("Country.Region"="country"))
