...
# 1st: cut data and save as lang+"_CutGoogleImpact"
for (country in countries){
...
# Next steps
1 Result between source_feat & TwitterImpact has certain trends
  - Change features definition
  - Test with Google trend
  
2 Other coorelation functions
