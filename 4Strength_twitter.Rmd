...
date_start = 18
date_end = 87
GetNeighData<-function(name, spath,nneigh,fs,path){
  ...
  for(n in neighs){
    ...
    if(i==1){
      data_other = other[date_start:date_end,2:ncol(other)] # 2.8 - 4.5
      i=2
    }
    else{
      data_other = data_other + other[date_start:date_end,2:ncol(other)] # 2.8
    }
  }
  return(data_other)
}
...
dat_other_it<-GetNeighData("It",short_paths,1,files_s,path_s)
cor_it = cor.test(dat_other_it$confirm,y_it)

dat_other_hi<-GetNeighData("Hi",short_paths,1,files_s,path_s)
cor_hi = cor.test(dat_other_hi$confirm,y_hi)

dat_other_ja<-GetNeighData("Ja",short_paths,1,files_s,path_s)
cor_ja = cor.test(dat_other_ja$confirm,y_ja)

dat_other_ko<-GetNeighData("Ko",short_paths,1,files_s,path_s)
cor_ko = cor.test(dat_other_ko$confirm,y_ko)

dat_other_de<-GetNeighData("De",short_paths,1,files_s,path_s)
cor_de = cor.test(dat_other_de$confirm,y_de)

dat_other_ru<-GetNeighData("Ru",short_paths,1,files_s,path_s)
cor_ru = cor.test(dat_other_ru$confirm,y_ru)
...
```{r, include=FALSE}
dat_other_it<-GetNeighData("It",short_paths,2,files_s,path_s)
cor_it = cor.test(dat_other_it$confirm,y_it)

dat_other_hi<-GetNeighData("Hi",short_paths,2,files_s,path_s)
cor_hi = cor.test(dat_other_hi$confirm,y_hi)

dat_other_ja<-GetNeighData("Ja",short_paths,2,files_s,path_s)
cor_ja = cor.test(dat_other_ja$confirm,y_ja)

dat_other_ko<-GetNeighData("Ko",short_paths,2,files_s,path_s)
cor_ko = cor.test(dat_other_ko$confirm,y_ko)

dat_other_de<-GetNeighData("De",short_paths,2,files_s,path_s)
cor_de = cor.test(dat_other_de$confirm, y_de)

dat_other_ru<-GetNeighData("Ru",short_paths,2,files_s,path_s)
cor_ru = cor.test(dat_other_ru$confirm,y_ru)
...
ggplot(plot_dat_conf,aes(x=type,y = cor))+geom_line(aes(group=name,colour=name))+geom_point(aes(colour=name))+ggtitle("Estimated Correlation")
...
dat_other_it<-GetNeighData("It",short_paths,1,files_s,path_s)
cor_it = cor.test(dat_other_it$confirm_daily,y_it)

dat_other_hi<-GetNeighData("Hi",short_paths,1,files_s,path_s)
cor_hi = cor.test(dat_other_hi$confirm_daily,y_hi)

dat_other_ja<-GetNeighData("Ja",short_paths,1,files_s,path_s)
cor_ja = cor.test(dat_other_ja$confirm_daily,y_ja)

dat_other_ko<-GetNeighData("Ko",short_paths,1,files_s,path_s)
cor_ko = cor.test(dat_other_ko$confirm_daily,y_ko)

dat_other_de<-GetNeighData("De",short_paths,1,files_s,path_s)
cor_de = cor.test(dat_other_de$confirm_daily,y_de)

dat_other_ru<-GetNeighData("Ru",short_paths,1,files_s,path_s)
cor_ru = cor.test(dat_other_ru$confirm_daily,y_ru)
...
dat_other_it<-GetNeighData("It",short_paths,1,files_s,path_s)
cor_it = cor.test(dat_other_it$death,y_it)

dat_other_hi<-GetNeighData("Hi",short_paths,1,files_s,path_s)
cor_hi = cor.test(dat_other_hi$death,y_hi)

dat_other_ja<-GetNeighData("Ja",short_paths,1,files_s,path_s)
cor_ja = cor.test(dat_other_ja$death,y_ja)

dat_other_ko<-GetNeighData("Ko",short_paths,1,files_s,path_s)
cor_ko = cor.test(dat_other_ko$death,y_ko)

dat_other_de<-GetNeighData("De",short_paths,1,files_s,path_s)
cor_de = cor.test(dat_other_de$death,y_de)

dat_other_ru<-GetNeighData("Ru",short_paths,1,files_s,path_s)
cor_ru = cor.test(dat_other_ru$death,y_ru)
...
ggplot(plot_dat_death,aes(x=type,y = cor))+geom_line(aes(group=name,colour=name))+ geom_point(aes(colour=name))#+ geom_ribbon(aes(ymin = lower,group=name, ymax=upper),alpha=.2)
...
dat_other_it<-GetNeighData("It",short_paths,1,files_s,path_s)
cor_it = cor.test(dat_other_it$death_daily,y_it)

dat_other_hi<-GetNeighData("Hi",short_paths,1,files_s,path_s)
cor_hi = cor.test(dat_other_hi$death_daily,y_hi)

dat_other_ja<-GetNeighData("Ja",short_paths,1,files_s,path_s)
cor_ja = cor.test(dat_other_ja$death_daily,y_ja)

dat_other_ko<-GetNeighData("Ko",short_paths,1,files_s,path_s)
cor_ko = cor.test(dat_other_ko$death_daily,y_ko)

dat_other_de<-GetNeighData("De",short_paths,1,files_s,path_s)
cor_de = cor.test(dat_other_de$death_daily,y_de)

dat_other_ru<-GetNeighData("Ru",short_paths,1,files_s,path_s)
cor_ru = cor.test(dat_other_ru$death_daily,y_ru)
...
ggplot(plot_dat_death_daily,aes(x=type,y = cor))+ geom_line(aes(group=name,colour=name))+ geom_point(aes(colour=name)) #+ geom_ribbon(aes(ymin = lower,group=name, ymax=upper),alpha=.2)
...
dat_other_it<-GetNeighData("It",short_paths,1,files_s,path_s)
cor_it = cor.test(dat_other_it$ConfDR,y_it)

dat_other_hi<-GetNeighData("Hi",short_paths,1,files_s,path_s)
cor_hi = cor.test(dat_other_hi$ConfDR,y_hi)

dat_other_ja<-GetNeighData("Ja",short_paths,1,files_s,path_s)
cor_ja = cor.test(dat_other_ja$ConfDR,y_ja)

dat_other_ko<-GetNeighData("Ko",short_paths,1,files_s,path_s)
cor_ko = cor.test(dat_other_ko$ConfDR,y_ko)

dat_other_de<-GetNeighData("De",short_paths,1,files_s,path_s)
cor_de = cor.test(dat_other_de$ConfDR,y_de)

dat_other_ru<-GetNeighData("Ru",short_paths,1,files_s,path_s)
cor_ru = cor.test(dat_other_ru$ConfDR,y_ru)
...
dat_other_it<-GetNeighData("It",short_paths,1,files_s,path_s)
cor_it = cor.test(dat_other_it$DeathR,y_it)

dat_other_hi<-GetNeighData("Hi",short_paths,1,files_s,path_s)
cor_hi = cor.test(dat_other_hi$DeathR,y_hi)

dat_other_ja<-GetNeighData("Ja",short_paths,1,files_s,path_s)
cor_ja = cor.test(dat_other_ja$DeathR,y_ja)

dat_other_ko<-GetNeighData("Ko",short_paths,1,files_s,path_s)
cor_ko = cor.test(dat_other_ko$DeathR,y_ko)

dat_other_de<-GetNeighData("De",short_paths,1,files_s,path_s)
cor_de = cor.test(dat_other_de$DeathR,y_de)

dat_other_ru<-GetNeighData("Ru",short_paths,1,files_s,path_s)
cor_ru = cor.test(dat_other_ru$DeathR,y_ru)
...
plot_dat<-data.frame(cor = c(cor_report_cf$cor,cor_report_cfd$cor,cor_report_d$cor,cor_report_dd$cor,cor_report_cdr$cor,cor_report_dr$cor),
                     pvalue = c(cor_report_cf$pvalue,cor_report_cfd$pvalue,cor_report_d$pvalue,cor_report_dd$pvalue,cor_report_cdr$pvalue,cor_report_dr$pvalue),
                       name = c(cor_report_cf$name,cor_report_cfd$name,cor_report_d$name,cor_report_dd$name,cor_report_cdr$name,cor_report_dr$name),
                       type = c(rep("Confirm",6),rep("Confirm_daily",6),rep("Death",6),rep("Death_daily",6),rep("ConfDR",6),rep("DeathR",6)))
